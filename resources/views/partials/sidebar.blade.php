...
<aside
    class="fixed md:static inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-blue-600 to-blue-700 flex flex-col shrink-0 transition-transform duration-300"
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        <p class="px-4 pt-1 pb-2 text-xs font-semibold text-blue-200 uppercase tracking-wider">Transaksi</p>
        ...
        <div class="border-t border-white/10 my-4"></div>
        <p class="px-4 pt-1 pb-2 text-xs font-semibold text-blue-200 uppercase tracking-wider">Pengaturan</p>
        ...
        @if (auth()->user()?->is_admin)
            <div class="border-t border-white/10 my-4"></div>
            <p class="px-4 pt-1 pb-2 text-xs font-semibold text-blue-200 uppercase tracking-wider">Administrator</p>
