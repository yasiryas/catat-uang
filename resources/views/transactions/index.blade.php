...
@section('content')
    <div x-data="transactionPage()" x-init="init()">
        ...
        <x-modal name="transaction-form" :show="modal.show" @close="modal.show = false" max-width="lg">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
        ...
        <x-modal name="transaction-delete" :show="deleteModal.show" @close="deleteModal.show = false" max-width="md">
